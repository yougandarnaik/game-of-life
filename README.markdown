...
[![Build Status](https://dev.azure.com/ynaik/Demo/_apis/build/status/yougandar.game-of-life?branchName=master)](https://dev.azure.com/ynaik/Demo/_build/latest?definitionId=2&branchName=master)
